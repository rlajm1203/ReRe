...
function SignupPage({}) {
  ...
  const handleIdDuplicate = () => {
    ...
    if (!errors.loginId) {
      axios
        .post("https://be.econo-rere.store/users/login-id/check", {
          loginId,
        })
        .then((res) => {
          console.log(res);
  ...
  const handleNicknameDuplicate = () => {
    ...
    if (!errors.nickname) {
      axios
        .post("https://be.econo-rere.store/users/nickname/check", {
          nickname,
        })
        .then((res) => {
          console.log(res);
  ...
  const handleSignup = (data) => {
    ...
    if (doubleName && doubleId) {
      axios
        .post("https://be.econo-rere.store/users/signup", data)
        .then((res) => {
          console.log(res);
          if (res.data.success) {
